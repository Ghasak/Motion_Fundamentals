...
myfont2 = pygame.font.SysFont('SF Mono', 100)
# --------------------------------------------------------
...
def Engine():
    ...
    while True:
        ...
        ParticleU.move_sequence(time_passed,C.x,C.y,D.x,D.y)



        Environment.timer_features(time_since_started = seconds)
        ParticleX.display()
        ParticleY.display()
        ParticleZ.display()
        ParticleU.display()
